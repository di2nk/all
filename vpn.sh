...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/di2nk/all/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://raw.githubusercontent.com/di2nk/all/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
...
mkdir clientconfig
cp /etc/openvpn/{netterz.crt,netterz.key,ca.crt,ta.key} clientconfig/
cd clientconfig
