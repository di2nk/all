...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/di2nk/all/main/addss.sh"
wget -O delss "https://raw.githubusercontent.com/di2nk/all/main/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/di2nk/all/main/cekss.sh"
wget -O xp-ss "https://raw.githubusercontent.com/di2nk/all/main/xp-ss.sh"
wget -O renewss "https://raw.githubusercontent.com/di2nk/all/main/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xp-ss
